			...
			<div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
				...
				<div>
					...
					<p className="text-sm text-muted-foreground max-w-sm mx-auto mt-2">
						Could not calculate the lineage graph for this resource. Make sure
						your CLI connectors have recently pushed lineage events.
					</p>
				</div>
			</div>
		);
		...
		<div className="space-y-8 animate-in fade-in duration-500 pb-8">
			...
			<div className="space-y-3">
				...
				<p className="text-[11px] text-muted-foreground leading-relaxed mt-2">
					Risk and sensitivity escalate upwards. If this asset consumes from a
					Highly Restricted source, it inherits that restriction automatically.
				</p>
			</div>
				...
				{hasPoisonPills ? (
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-xs text-rose-500/80 leading-relaxed mt-1">
									This asset contains data derived from sources that explicitly
									forbid secondary usage (e.g., AI Training or Marketing).
								</p>
							</div>
						</div>
					...
					<div className="p-5 text-center rounded-xl border border-dashed bg-emerald-500/5">
						...
						<p className="text-xs text-muted-foreground mt-1 max-w-[250px] mx-auto">
							This asset has not inherited any restrictive usage policies from
							its data sources.
						</p>
					</div>
				)}
			...
			<div className="space-y-4">
				...
				{!hasUpstream ? (
					<div className="p-5 text-center rounded-xl border border-dashed bg-muted/5">
						...
						<p className="text-xs text-muted-foreground mt-1 max-w-[250px] mx-auto">
							This resource has no upstream dependencies. It is the origin point
							of the data.
						</p>
					</div>
				) : (
						...
						<ScrollArea className="max-h-[250px]">
							<div className="divide-y divide-border/50">
								{analysis.upstream_path.map((urn, idx) => {
									...
									const isPoisoned =
										analysis.poisoned_constraints.includes(urn);
									...
									return (
										...
										>
											...
											>
												{platform.includes("snowflake") ||
												platform.includes("postgres") ? (
