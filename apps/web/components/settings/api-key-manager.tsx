            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Generate and manage machine credentials for the Ambyte SDK, CLI, and data connectors.
                    </p>
                </div>
            ...
            <Card className="border-border/50 shadow-sm bg-card">
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center border-dashed border-2 border-border/50 m-6 rounded-xl bg-muted/5">
                        ...
                        <h4 className="text-sm font-semibold text-foreground">No API Keys Found</h4>
                        <p className="text-sm text-muted-foreground mt-1 max-w-sm">
                            You haven't generated any machine credentials yet. Create one to connect your pipelines.
                        </p>
                        <Button
                            variant="outline"
                            className="mt-6"
                                    ...
                                    <TableCell>
                                        <div className="flex flex-wrap gap-1">
                                            {apiKey.scopes.slice(0, 2).map((scope) => (
                                                <Badge key={scope} variant="secondary" className="text-[10px] font-mono px-1.5 py-0">
                                                    {scope}
                                                </Badge>
                                            ))}
                ...
                <DialogContent className="sm:max-w-md border-rose-500/30">
                    <DialogHeader>
                        ...
                        <DialogDescription className="pt-2">
                            ...
                            Any applications or pipelines using this key will immediately lose access. This action cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
...
function CreateKeyModal({
    ...
    const [scopes, setScopes] = useState<string[]>(["check:write", "audit:write"]);
    ...
    // Result State
    const [generatedSecret, setGeneratedSecret] = useState<ApiKeySecret | null>(null);
                    ...
                    <div className="space-y-6">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-foreground/90">
                                ...
                                <strong> you will not be able to see it again</strong> after closing this window.
                            </DialogDescription>
                        </DialogHeader>
