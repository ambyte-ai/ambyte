...
const PIPELINE_STEPS = [
	...
	},
	{
		...
		description:
			"Generating mathematical representations for the knowledge graph.",
		icon: Database,
	},
	{
		id: "DEFINING",
		...
		description:
			"Identifying capitalized defined terms (e.g., 'Customer Data').",
		icon: BookOpen,
	},
	{
		id: "EXTRACTION",
		...
		<div className={cn("flex flex-col", className)}>
			{PIPELINE_STEPS.map((step, index) => {
				...
				if (isPast) {
					...
					bgColor =
						"bg-indigo-500/10 border-indigo-500/30 shadow-[0_0_15px_-3px_rgba(99,102,241,0.2)]";
					lineColor = "bg-border";
				} else if (isErrorStep) {
					iconColor = "text-rose-500";
					bgColor =
						"bg-rose-500/10 border-rose-500/30 shadow-[0_0_15px_-3px_rgba(244,63,94,0.2)]";
					lineColor = "bg-border";
				}
