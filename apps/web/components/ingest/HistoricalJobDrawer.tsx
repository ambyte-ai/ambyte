                ...
                <div className="px-6 py-4 border-b border-border/50 bg-muted/10 shrink-0">
                    <SheetHeader>
                        <SheetTitle className="text-lg font-bold flex items-center gap-2">
                            Historical Ingestion: <span className="font-mono text-primary font-normal">{filename}</span>
                        </SheetTitle>
                        <SheetDescription className="text-xs">
                            Processed in {duration} • Job ID: <span className="font-mono">{job.job_id}</span>
                        </SheetDescription>
                    </SheetHeader>
                </div>
