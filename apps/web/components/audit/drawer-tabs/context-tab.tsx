...
import { Bot, Check, Copy, ExternalLink, Shield, User } from "lucide-react";
				...
				<div className="flex items-center gap-3 p-4 border-b border-border/30 bg-muted/10">
					...
					<div className="flex-1 min-w-0">
						...
						<div className="flex items-center gap-2 mt-0.5">
							...
							>
								{actorId.includes("@") ? "Human" : "Service Account"}
							</Badge>
						</div>
					</div>
				</div>
				...
				<div className="divide-y divide-border/30">
					...
					<div className="flex items-center justify-between px-4 py-2.5">
						...
						<div className="flex items-center gap-1">
							...
							<CopyButton text={log.resource_urn} label="Copy Resource URN" />
						</div>
					</div>
					<div className="flex items-center justify-between px-4 py-2.5">
