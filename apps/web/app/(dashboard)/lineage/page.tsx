			...
			<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between shrink-0">
				<div>
					...
					<p className="text-sm text-muted-foreground mt-1">
						Interactive threat map for data lineage, risk propagation, and
						"Poison Pill" diagnostics.
					</p>
				</div>
				...
				<div className="flex items-center gap-3">
					...
					<div
						className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-md bg-muted/30 border border-border/50 text-xs text-muted-foreground cursor-not-allowed opacity-70"
						title="Coming soon: Select two nodes to simulate a join"
					>
