    ...
    const { logs, isLoading, isValidating, refresh } = useAuditLogs(
        {
            ...
            actorId: searchQuery.includes("@") || searchQuery.includes("_")
                ? searchQuery
                : undefined,
            resourceUrn: searchQuery.includes(":")
                ? searchQuery
                : undefined,
        },
        isLiveTail
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Cryptographically sealed record of all policy
                        evaluations and data access events.
                    </p>
                </div>
                <div className="flex items-center gap-2">
                    <Button
